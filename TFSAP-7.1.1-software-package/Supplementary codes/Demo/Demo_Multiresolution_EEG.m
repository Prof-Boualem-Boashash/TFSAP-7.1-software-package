...
plotDWT(sig_seiz,'db4'); %Multiresolution algorithm applied to a EEG seizure signal

plotDWT(sig_back,'db4'); %Multiresolution algorithm applied to a EEG background signal