...
*
* Description:
 * Instantaneous Frequency Estimation by Finite Phase Difference
 * method and Kay method
...
int pdeIF(double *signal_real, double *signal_imag, 
        int signal_length, double *result, 
        int window_length, int estimator_order,
        int Kay);
