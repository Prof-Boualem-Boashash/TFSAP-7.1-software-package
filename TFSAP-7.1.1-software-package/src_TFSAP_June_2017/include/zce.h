...
*
* Description:
 * Instantaneous Frequency Estimation by Zero-Crossing method
 * 
 ********************************************************************/
...
/*
 * int wvd( double *signal_real, double *signal_imag, unsigned
 *          signal_length, double *result, unsigned num_slices,
 *          unsigned time_res, unsigned window_length, unsigned
 *          window_r2, unsigned window_order)
 *
 * Description:
 * 
...
int zce(double *signal_real, double *signal_imag, 
        unsigned signal_length, double *result, 
        unsigned window_length);
